<section id="mainDescription">
  <div class="content contentDescription">
    ...
    <p class="text wow fadeInUp" data-wow-delay='0.2s'>
      <?php if (Lang\getLang() == 'en') { ?>
        Leader in real estate developments, hospitality and cruise ports, ITM Group is a Mexican and multidisciplinary company with more than <b>50 years of experience</b> in the Mexican Caribbean and the world.
      <?php } else { ?>
        Líder en desarrollos inmobiliarios, hospitalidad y puertos de cruceros, ITM Group es una empresa mexicana y multidisciplinaria con más de <b>50 años de experiencia</b> en el Caribe Mexicano y el mundo.
      <?php } ?>
  ...
  <div class="content contentBanner parallaxHolder">
    ...
    <p class="bigText">
      <?php if (Lang\getLang() == 'en') { ?>
        Building <b>experiences</b> with <b>passion</b> since 1978
      <?php } else { ?>
        Construyendo <b>experiencias</b> con <b>pasión</b> desde 1978
      <?php } ?>
    </p>
  </div>
</section>
