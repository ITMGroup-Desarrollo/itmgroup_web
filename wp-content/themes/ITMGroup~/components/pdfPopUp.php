<section id="popup" class="modal">
  ...
  <div class="modalWrapper">
    <img mnr-src="<?= Util\root() ?>/assets/popup1.jpg" width="100%" height="100%" alt="popup">
    <a href="<?= Util\root() ?>/assets/Seatrade-ITM.pdf" download="Seatrade-ITM.pdf" class="button">
        DOWNLOAD <b>Our eBook Ports Destinations</b>
    </a>
  </div>
</section>
