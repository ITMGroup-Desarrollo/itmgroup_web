...
<a href="http://itmgroup.mx/book/itm-magazine" target="_blank" rel="noopener noreferrer">
  <div class="modalWrapper">
    <img mnr-src="<?= Util\root() ?>/assets/popUpRevistaEn.jpg" width="100%" height="100%" alt="popup">
</div>
</a>
<?php } else { ?>
<a href="http://itmgroup.mx/book/itm-magazine" target="_blank" rel="noopener noreferrer">
  <div class="modalWrapper">
    <img mnr-src="<?= Util\root() ?>/assets/popUpRevista.jpg" width="100%" height="100%" alt="popup">
</div>
</a>
<?php } ?>
</section>
