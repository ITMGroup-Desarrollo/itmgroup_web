  ...
  <div class="content ">
    ...
    <div class="iconCard">
      <img class="icon wow fadeInUp" data-wow-delay='0.1s'
        mnr-src="<?= Util\root() ?>/assets/boat-n.gif"
        alt="icon"
        width="100%"
        height="100%">
    </div>
    <div class="iconCard wow fadeInUp">
      <img class="icon" data-wow-delay='0.2s'
        mnr-src="<?= Util\root() ?>/assets/real-estate-new.gif"
        alt="icon"
        width="100%"
        height="100%">
    </div>
    <div class="iconCard">
      <img class="icon last" data-wow-delay='0.3s'
        mnr-src="<?= Util\root() ?>/assets/comp-nw.gif"
        alt="icon"
        width="100%"
        height="100%">
    </div>
    ...
    <div class="card wow fadeInUp" division-card data-wow-delay='0.1s'>
      <img class="banner"
        mnr-src="<?= Util\root() ?>/assets/ports/taino-bay/cruise-port.jpg"
        alt="banner"
        width="100%"
        height="100%">
