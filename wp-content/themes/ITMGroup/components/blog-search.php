...
<section id="blog" >
  <div class="content content-search">
    ...
    <?php if(Lang\getLang() == 'en'){ ?>
         <form action="/press-search" search-form method="get">
    <?php } else { ?>
         <form action="/prensa-busqueda" search-form method="get">
    <?php } ?>
      <div class="inputHolder search-holder">
        
        <?php if(Lang\getLang() == 'en'){ ?>
              <input required value="<?= $query ?>" class="input" name="q" search placeholder="¿What are you searching?">
        <?php } else { ?>
              <input required value="<?= $query ?>" class="input" name="q" search placeholder="¿Que estas buscando?">
        <?php } ?>
  ...
  <div class="content title-content">
    ...
    <div class="postsGrid">
            <?php 
              $posts = Blog\getQueryPosts($query);
...
#blog .postsGrid:not(:has(.postCard)) .text-empty{
  display: block;
}
