<section id="popup" class="modal">
  ...
  <div class="modalWrapper">
    <img mnr-src="<?= Util\root() ?>/assets/bannerPopup.jpeg" width="100%" height="100%" alt="popup">
    <a href="https://www.instagram.com/itmgroupmx/" target="_blank" class="button">
       CLICK HERE TO <b>DISCOVER MORE!</b>
    </a>
  </div>
</section>
